 ...
 */
public record ChoerbliDto(UUID id, String name, String description, Date startDate, Date endDate, ChoerbliStateDto state, List<VoteDto> votes, List<ItemDto> items) {
}
